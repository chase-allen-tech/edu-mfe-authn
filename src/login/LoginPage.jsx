...
import imgLogoGoogle from '../assets/logo_google.png';
          ...
          <Form>
            ...
            <div className="w-100 text-center">
              ...
              <div className="flex justify-content-center align-items-center">
                <img src={imgLogoGoogle} alt="" className="w-google m-2" />
                <img src={imgLogoApple} alt="" className="w-google m-2" />
              </div>
              <div className="mtp-30 fsp-12">Copyright &copy; 2020</div>
            </div>
